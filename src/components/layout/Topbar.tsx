...
import { Search, Bell, CheckCircle2, AlertCircle, Info, Trash2, Moon, Sun } from "lucide-react";
    ...
    return (
        <header className="h-16 shrink-0 flex items-center justify-between px-6 bg-background border-b border-border z-[1000]">
            ...
            <div className="flex items-center gap-4 ml-6">
                ...
                <div className="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-sm font-medium text-foreground cursor-pointer ml-2">
